...
import com.wannabeuk.cctransfer.creativetab.ModCreativeTabs;
...
public class Utils 
{
	...
	{
		if (item.getRegistryName().toString().contains((Reference.MOD_ID)))
		{
	...
	{
		Main.info("Logical Side: " + getLogicalSide(world));
	}
